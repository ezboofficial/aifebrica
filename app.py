from flask import Flask, request, jsonify, render_template, redirect, url_for, flash, Response, session, send_from_directory
import os
import logging
...
def order_lists():
    ...
    return render_template('orderlists.html', 
                         title="Order Lists", 
                         orders=messageHandler.get_orders(), 
                         AI_ENABLED=AI_ENABLED)
...
def sales_logs():
    ...
    return render_template('saleslogs.html', 
                         title="Sales Logs", 
                         sales_logs=messageHandler.sales_logs, 
                         settings=messageHandler.get_settings(), 
