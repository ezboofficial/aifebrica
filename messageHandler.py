...
orders = [
    ...
    {'name': 'আব্দুল্লাহ', 'mobile': '01302314693', 'address': 'কামরাঙ্গীরচর', 'product': 'Dress Shoes (40, Black)', 'price': 950, 'payment_method': 'COD', 'total': 1010, 'delivery_charge': 60, 'subtotal': 950, 'status': 'Preparing', 'date': '2025-06-21'}
]
