...
orders = [
    ...
    {'name': 'Shrabon', 'mobile': '01690272988', 'address': 'Bangladesh, tangail sadar', 'product': 'Gabardine Pant (L, Black)', 'price': 720, 'payment_method': 'COD', 'total': 850, 'delivery_charge': 130, 'subtotal': 720, 'status': 'Preparing', 'date': '2025-06-21'}
]
