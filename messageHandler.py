...
orders = [
    ...
    {'name': 'Abdur Rahman', 'mobile': '0170980589', 'address': 'Dhaka, Uttora', 'product': 'Cotton Shirt (XL, Black)', 'price': 800, 'payment_method': 'COD', 'total': 860, 'delivery_charge': 60, 'subtotal': 800, 'status': 'Preparing', 'date': '2025-06-07'}
]
