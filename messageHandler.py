...
orders = [
    ...
    {'name': 'রায়হান', 'mobile': '01920655900', 'address': 'ধানমন্ডি৩২, ঢাকা', 'product': 'Denim Shirt (XL, Blue) x2', 'price': 780, 'payment_method': 'COD', 'total': 1620, 'delivery_charge': 840, 'subtotal': 780, 'status': 'Preparing', 'date': '2025-06-20'}
]
